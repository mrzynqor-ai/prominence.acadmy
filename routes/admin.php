...
Route::name('admin.')->prefix('admin')->middleware('admin')->group(function () {
    ...
    Route::get('course/change_course_author/{id}', [CourseController::class, 'change_course_author'])->name('course.change_course_author');
    Route::post('course/change_course_author/store/{id}', [CourseController::class, 'change_course_author_store'])->name('course.change_course_author.store');
    Route::get('course/remove_an_instructor/{course_id}/{instructor_id}', [CourseController::class, 'remove_an_instructor'])->name('course.remove_an_instructor');
    ...
    Route::controller(SettingController::class)->group(function () {
        ...
        // Zapier settings
        Route::get('zapier_settings/{slug?}', 'zapier_settings')->name('zapier.settings');
        Route::post('zapier_settings/update/{slug}', 'zapier_settings_update')->name('zapier.settings.update');

        // Amazon S3 settings
        Route::get('amazom_s3/{slug?}', 'amazom_s3_settings')->name('amazom_s3.settings');
        Route::post('amazom_s3_settings/update', 'amazom_s3_settings_update')->name('amazom_s3.settings.update');
    ...
    Route::controller(CustomerSupportController::class)->group(function () {
        ...
        Route::get('customer/support/ticket/index', 'customer_support_ticket_index')->name('customer.support.ticket.index');
        Route::get('customer/support/ticket/create', 'customer_support_ticket_create')->name('customer.support.ticket.create');
        Route::post('customer/support/ticket/store', 'customer_support_ticket_store')->name('customer.support.ticket.store');
        Route::get('customer/support/ticket/edit/{id}', 'customer_support_ticket_edit')->name('customer.support.ticket.edit');
        Route::post('customer/support/ticket/update/{id}', 'customer_support_ticket_update')->name('customer.support.ticket.update');
        Route::get('customer/support/ticket/delete/{id}', 'customer_support_ticket_delete')->name('customer.support.ticket.delete');

        // TICKET MESSAGE ROUTES
        Route::get('customer/support/ticket/message/{ticket_thread_code?}', 'customer_support_ticket_message')->name('customer.support.ticket.message');
        Route::post('customer/support/ticket/message/store', 'customer_support_ticket_message_store')->name('customer.support.ticket.message.store');

        // TICKET FAQ ROUTES
        Route::get('customer/support/ticket/faq/index', 'customer_support_ticket_faq_index')->name('customer.support.ticket.faq.index');
        Route::get('customer/support/ticket/faq/create', 'customer_support_ticket_faq_create')->name('customer.support.ticket.faq.create');
        Route::post('customer/support/ticket/faq/store', 'customer_support_ticket_faq_store')->name('customer.support.ticket.faq.store');
        Route::get('customer/support/ticket/faq/edit/{id}', 'customer_support_ticket_faq_edit')->name('customer.support.ticket.faq.edit');
        Route::post('customer/support/ticket/faq/update/{id}', 'customer_support_ticket_faq_update')->name('customer.support.ticket.faq.update');
        Route::get('customer/support/ticket/faq/delete/{id}', 'customer_support_ticket_faq_delete')->name('customer.support.ticket.faq.delete');

        //TICKET REPORT ROUTES
        Route::get('customer/support/ticket/report', 'customer_support_ticket_report')->name('customer.support.ticket.report');

        // TICKET MACRO ROUTES
        Route::get('customer/support/ticket/macro/index', 'customer_support_ticket_macro_index')->name('customer.support.ticket.macro.index');
        Route::get('customer/support/ticket/macro/create', 'customer_support_ticket_macro_create')->name('customer.support.ticket.macro.create');
        Route::post('customer/support/ticket/macro/store', 'customer_support_ticket_macro_store')->name('customer.support.ticket.macro.store');
        Route::get('customer/support/ticket/macro/edit/{id}', 'customer_support_ticket_macro_edit')->name('customer.support.ticket.macro.edit');
        Route::post('customer/support/ticket/macro/update/{id}', 'customer_support_ticket_macro_update')->name('customer.support.ticket.macro.update');
        Route::get('customer/support/ticket/macro/delete/{id}', 'customer_support_ticket_macro_delete')->name('customer.support.ticket.macro.delete');

        // TICKET CATEGORY ROUTES
        Route::get('customer/support/ticket/category/index', 'customer_support_ticket_category_index')->name('customer.support.ticket.category.index');
        Route::get('customer/support/ticket/category/create', 'customer_support_ticket_category_create')->name('customer.support.ticket.category.create');
        Route::post('customer/support/ticket/category/store', 'customer_support_ticket_category_store')->name('customer.support.ticket.category.store');
        Route::get('customer/support/ticket/category/edit/{id}', 'customer_support_ticket_category_edit')->name('customer.support.ticket.category.edit');
        Route::post('customer/support/ticket/category/update/{id}', 'customer_support_ticket_category_update')->name('customer.support.ticket.category.update');
        Route::get('customer/support/ticket/category/delete/{id}', 'customer_support_ticket_category_delete')->name('customer.support.ticket.category.delete');

        // TICKET PRIORITY ROUTES
        Route::get('customer/support/ticket/priority/index', 'customer_support_ticket_priority_index')->name('customer.support.ticket.priority.index');
        Route::get('customer/support/ticket/priority/create', 'customer_support_ticket_priority_create')->name('customer.support.ticket.priority.create');
        Route::post('customer/support/ticket/priority/store', 'customer_support_ticket_priority_store')->name('customer.support.ticket.priority.store');
        Route::get('customer/support/ticket/priority/edit/{id}', 'customer_support_ticket_priority_edit')->name('customer.support.ticket.priority.edit');
        Route::post('customer/support/ticket/priority/update/{id}', 'customer_support_ticket_priority_update')->name('customer.support.ticket.priority.update');
        Route::get('customer/support/ticket/priority/delete/{id}', 'customer_support_ticket_priority_delete')->name('customer.support.ticket.priority.delete');

        // TICKET STATUS ROUTES
        Route::get('customer/support/ticket/status/index', 'customer_support_ticket_status_index')->name('customer.support.ticket.status.index');
        Route::get('customer/support/ticket/status/create', 'customer_support_ticket_status_create')->name('customer.support.ticket.status.create');
        Route::post('customer/support/ticket/status/store', 'customer_support_ticket_status_store')->name('customer.support.ticket.status.store');
        Route::get('customer/support/ticket/status/edit/{id}', 'customer_support_ticket_status_edit')->name('customer.support.ticket.status.edit');
        Route::post('customer/support/ticket/status/update/{id}', 'customer_support_ticket_status_update')->name('customer.support.ticket.status.update');
        Route::get('customer/support/ticket/status/delete/{id}', 'customer_support_ticket_status_delete')->name('customer.support.ticket.status.delete');
    });
    ...
    // ebook_category
    Route::get('ebook/categories', [EbookCategoryController::class, 'index'])->name('ebook.categories');
    Route::post('ebook/categories/store', [EbookCategoryController::class, 'store'])->name('ebook.categories.store');
    Route::get('ebook/categories/delete/{id}', [EbookCategoryController::class, 'delete'])->name('ebook.categories.delete');
    Route::get('ebook/categories/edit/{id}', [EbookCategoryController::class, 'edit'])->name('ebook.categories.edit');
