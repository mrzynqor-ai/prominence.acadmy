{{-- To make a editable image or text need to be add a "builder editable" class and builder identity attribute with a
unique value --}}
        ...
        <div class="row">
            <div class="col-lg-4 col-md-4">
                <div class="footer-content drop-area">
                    ...
                    <p class="description builder-editable" builder-identity="1">
                    ...
                    <ul class="f-socials d-flex">
                        ...
                        <li><a href="{{ get_frontend_settings('facebook') }}"><i
                                    class="fa-brands fa-facebook-f"></i></a></li>
                        <li><a href="{{ get_frontend_settings('linkedin') }}"><i
                    ...
                    <a href="{{ get_frontend_settings('mobile_app_link') }}" target="_blank" class="mt-4">
                        <svg xmlns="http://www.w3.org/2000/svg" width="162" height="48" viewbox="0 0 162 48"
                            ...
                            <rect x="0.6" y="0.6" width="160.8" height="46.8" rx="5.4" stroke="#A6A6A6"
                            ...
                            <path
                                ...
                                fill="white"></path>
                            <path
                                d="M24.8617 23.3081L12.0859 36.8681C12.0864 36.8709 12.0874 36.8732 12.0879 36.8761C12.4797 38.3484 13.8245 39.4326 15.4206 39.4326C16.0587 39.4326 16.6577 39.2601 17.1714 38.9573L17.2122 38.9334L31.593 30.6351L24.8617 23.3081Z"
                                fill="#EA4335"></path>
                            <path
                                d="M37.778 20.9991L37.7657 20.9907L31.5572 17.3915L24.5625 23.6157L31.5815 30.6338L37.7573 27.0704C38.8401 26.4859 39.5751 25.3444 39.5751 24.0281C39.5751 22.7213 38.8499 21.5855 37.778 20.9991Z"
                                fill="#FBBC04"></path>
                            <path
                                d="M12.0781 11.1319C12.0013 11.4151 11.9609 11.7117 11.9609 12.0197V35.9809C11.9609 36.2883 12.0008 36.586 12.0786 36.8682L25.2941 23.6551L12.0781 11.1319Z"
                                fill="#4285F4"></path>
                            <path
                                d="M24.9408 24L31.5535 17.3892L17.189 9.06096C16.6669 8.74824 16.0576 8.56776 15.4055 8.56776C13.8094 8.56776 12.4627 9.65388 12.0708 11.1281C12.0703 11.1295 12.0703 11.1305 12.0703 11.1318L24.9408 24Z"
                                fill="#34A853"></path>
                        </svg>
                    </a>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="footer-widget">
                            ...
                            <ul class=" drop-area">
                                ...
                                <li><a
                                        href="{{ route('certificate.verify') }}">{{ get_phrase('Verify Certificate') }}</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="col-lg-4">
                    <div class="copyright-text">
                        <p class="text-sm text-gray-300">
                            &copy; {{ date('Y') }}
                            {{ app()->getLocale() == 'ar' ? 'جميع الحقوق محفوظة - تم التطوير بواسطة' : 'All Rights Reserved - Developed by' }}
