...
@include('components.home_made_by_builder.certificate_verify_banner')
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="footer-widget">
                            ...
                            <ul class=" drop-area">
                                ...
                                <li><a href="{{ route('certificate.verify') }}">{{ get_phrase('Verify Certificate') }}</a></li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="copyright-text">
                        <p class="builder-editable" builder-identity="4">{{ get_phrase('© Creativeitem All Rights Reserved') }}</p>
                    </div>
                </div>
            </div>
        </div>
