...
{{-- -------------- e-book manu start ------------------------------ --}}
@if (has_permission('admin.ebooks'))
<li class="sidebar-first-li first-li-have-sub @if ($current_route == 'admin.ebooks' || $current_route == 'admin.ebook.edit' || $current_route == 'admin.ebook.create' || $current_route == 'admin.ebook.admin-revenue' || $current_route == 'admin.ebook.instructor-revenue' || $current_route == 'admin.ebook.categories') active showMenu @endif">
    <a href="javascript:void(0);">
    ...
    <ul class="first-sub-menu">
        ...
        <li class="sidebar-second-li @if ($current_route == 'admin.ebooks' || $current_route == 'admin.ebook.edit') active @endif">
            <a href="{{ route('admin.ebooks') }}">{{ get_phrase('Manage Ebooks') }}</a>
        </li>
        <li class="sidebar-second-li @if ($current_route == 'admin.ebook.create') active @endif">
            <a href="{{ route('admin.ebook.create') }}">{{ get_phrase('Add New Ebook') }}</a>
        </li>
        <li class="sidebar-second-li @if ($current_route == 'admin.ebook.admin-revenue') active @endif">
            <a href="{{ route('admin.ebook.admin-revenue') }}">{{ get_phrase('Admin revenue') }}</a>
        </li>
        <li class="sidebar-second-li @if ($current_route == 'admin.ebook.instructor-revenue') active @endif">
            <a href="{{ route('admin.ebook.instructor-revenue') }}">{{ get_phrase('Instructor revenue') }}</a>
        </li>
        <li class="sidebar-second-li @if ($current_route == 'admin.ebook.categories') active @endif">
            <a href="{{ route('admin.ebook.categories') }}">{{ get_phrase('Category') }}</a>
        </li>
    </ul>
</li>
@endif
...
@if (has_permission('admin.customer.support.ticket.index'))
<li class="sidebar-first-li first-li-have-sub @if (
                    $current_route == 'admin.customer.support.ticket.index' ||
                        $current_route == 'admin.customer.support.ticket.create' ||
                        $current_route == 'admin.customer.support.ticket.edit' ||
                        $current_route == 'admin.customer.support.ticket.message' ||
                        $current_route == 'admin.customer.support.ticket.faq.index' ||
                        $current_route == 'admin.customer.support.ticket.report' ||
                        $current_route == 'admin.customer.support.ticket.macro.index' ||
                        $current_route == 'admin.customer.support.ticket.category.index' ||
                        $current_route == 'admin.customer.support.ticket.priority.index' ||
                        $current_route == 'admin.customer.support.ticket.status.index') active @endif">
    <a href="javascript:void(0);">
        <span class="fi fi-rr-headset icon"></span>
        <div class="text">
            <span>{{ get_phrase('Customer Support') }}</span>
        </div>
    </a>
    <ul class="first-sub-menu">
        <li class="first-sub-menu-title fs-14px mb-18px">{{ get_phrase('Customer Support') }}</li>

        @if (has_permission('admin.customer.support.ticket.index'))
        <li class="sidebar-second-li {{ $current_route == 'admin.customer.support.ticket.index' || $current_route == 'admin.customer.support.ticket.edit' || $current_route == 'admin.customer.support.ticket.message' ? 'active' : '' }}">
            <a href="{{ route('admin.customer.support.ticket.index') }}">{{ get_phrase('Tickets') }}</a>
        </li>
        @endif
        @if (has_permission('admin.customer.support.ticket.create'))
        <li class="sidebar-second-li {{ $current_route == 'admin.customer.support.ticket.create' ? 'active' : '' }}">
            <a href="{{ route('admin.customer.support.ticket.create') }}">{{ get_phrase('Add New Ticket') }}</a>
        </li>
        @endif
        @if (has_permission('admin.customer.support.ticket.faq.index'))
        <li class="sidebar-second-li {{ $current_route == 'admin.customer.support.ticket.faq.index' ? 'active' : '' }}">
            <a href="{{ route('admin.customer.support.ticket.faq.index') }}">{{ get_phrase('FAQ') }}</a>
        </li>
        @endif
        @if (has_permission('admin.customer.support.ticket.report'))
        <li class="sidebar-second-li {{ $current_route == 'admin.customer.support.ticket.report' ? 'active' : '' }}">
            <a href="{{ route('admin.customer.support.ticket.report') }}">{{ get_phrase('Reports') }}</a>
        </li>
        @endif

        <li class="sidebar-second-li second-li-have-sub @if ($current_route == 'admin.customer.support.ticket.macro.index' || $current_route == 'admin.customer.support.ticket.category.index' || $current_route == 'admin.customer.support.ticket.priority.index' || $current_route == 'admin.customer.support.ticket.status.index') active @endif">
            <a href="javascript:void(0);">{{ get_phrase('Settings') }}</a>
            <ul class="second-sub-menu">

                @if (has_permission('admin.customer.support.ticket.macro.index'))
                <li class="sidebar-third-li @if ($current_route == 'admin.customer.support.ticket.macro.index') active @endif">
                    <a href="{{ route('admin.customer.support.ticket.macro.index') }}">{{ get_phrase('Ticket Macros') }}</a>
                </li>
                @endif
                @if (has_permission('admin.customer.support.ticket.category.index'))
                <li class="sidebar-third-li @if ($current_route == 'admin.customer.support.ticket.category.index') active @endif">
                    <a href="{{ route('admin.customer.support.ticket.category.index') }}">{{ get_phrase('Ticket Categories') }}</a>
                </li>
                @endif
                @if (has_permission('admin.customer.support.ticket.priority.index'))
                <li class="sidebar-third-li @if ($current_route == 'admin.customer.support.ticket.priority.index') active @endif">
                    <a href="{{ route('admin.customer.support.ticket.priority.index') }}">{{ get_phrase('Ticket Priorities') }}</a>
                </li>
                @endif
                @if (has_permission('admin.customer.support.ticket.status.index'))
                <li class="sidebar-third-li @if ($current_route == 'admin.customer.support.ticket.status.index') active @endif">
                    <a href="{{ route('admin.customer.support.ticket.status.index') }}">{{ get_phrase('Ticket Status') }}</a>
                </li>
                @endif
            </ul>
        </li>
...
@if (has_permission('admin.blogs') || has_permission('admin.blog.pending') || has_permission('admin.blog.category') || has_permission('admin.blog.category'))
<li
    ...
    <ul class="first-sub-menu">
        ...
        <li class="sidebar-second-li {{ $current_route == 'admin.blog.pending' ? 'active' : '' }}">
    ...
    <ul class="px-14px pb-24px mb-5 pb-5">
        <li
            ...
            <ul class="first-sub-menu">
                ...
                <li class="sidebar-second-li {{ $current_route == 'admin.amazom_s3.settings' ? 'active' : '' }}">
                    <a href="{{ route('admin.amazom_s3.settings') }}">{{ get_phrase('Amazon s3 settings ') }}</a>
                </li>
                @endif
