                    ...
                    <form class="required-form" action="{{ route('admin.system.settings.update') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="fpb-7 mb-3">
                            ...
                            <select class="form-control ol-form-control ol-select2" data-toggle="select2" name="language" id="language">
                                ...
                                <option value="{{strtolower($language->name)}}" @if (strtolower(get_settings('language'))==strtolower($language->name)) selected @endif>{{ $language->name }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="fpb-7 mb-3">
                            ...
                            <p style="font-size: 12px; font-weight: 500;">{{get_phrase("Specify the maximum number of devices a user can log in from. If set to 0, users will be able to log in from an unlimited number of devices.")}}</p>
                        </div>

                        <div class="fpb-7 mb-3">
                            <label class="form-label ol-form-label" for="timezone">{{ get_phrase('Timezone') }}</label>
